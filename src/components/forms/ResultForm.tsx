...
const ResultForm = ({type,data}:{type:"create" | "update";data?:any;}) => {
  ...
  return (
    <form className='flex flex-col gap-8' onSubmit={onSubmit}>
        ...
        <InputField label="Birth Date" type="date" name="birthDate" defaultValue={data?.birthDate} register={register} error={errors.birthDate}/>
        ...
        <button className="p-2 bg-blue-400 text-white rounded-md">{type==="create" ? "Create" : "Update"}</button>
